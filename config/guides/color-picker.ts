...
const guide: ToolGuide = {
  ...
  sections: [
    {
      heading: "HEX vs RGB vs HSL vs HSV: When to Use Each",
      paragraphs: [
  ...
  mistakes: [
    { title: "Manually converting between HEX and RGB by hand", description: "Manual conversion introduces rounding errors; paste the value you have into a text field and let the tool calculate the rest." },
    ...
    { title: "Copying plain RGB when you needed transparency", description: "Set the alpha slider and copy the RGBA or HEX8 row instead of appending an alpha value to the plain RGB numbers by hand." },
    { title: "Confusing HSL and HSV numbers", description: "They share a hue but not the other two components; #3366CC is hsl(220, 60%, 50%) but hsv(220, 75%, 80%), so copy the row that matches your target field." },
  ...
  glossary: [
    ...
    { title: "HSV", description: "A color format using hue, saturation, and value (brightness), the model behind the gradient squares in Photoshop, GIMP, and Figma's color pickers." },
    { title: "HEX8", description: "An eight-digit hex code where the final two digits carry the alpha channel, so #3366CC80 is #3366CC at roughly 50% opacity." },
    { title: "Alpha channel", description: "A transparency value added to a color format (as in RGBA or HEX8) that controls how see-through a color appears." },
