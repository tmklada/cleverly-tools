...
const config: ToolConfig = {
  ...
  description: "Convert Markdown text to clean, ready-to-use HTML code instantly in your browser. Supports headings, bold, italic, links, lists, blockquotes, and code blocks — with a live preview.",
  ...
  toolType: "text",
  faq: [
    { question: "What Markdown features are supported?", answer: "The converter supports headings (H1-H3), bold, italic, links, unordered lists, blockquotes, fenced code blocks, and inline code. Ordered lists, images, and tables are not converted yet." },
